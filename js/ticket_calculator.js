...
let total = 0;                                                  //итогова€ сумма по чеку




//получить значение первого <p> родител€
...
let total_amount = 0.00;        //обща€ сумма*/
...
//установить нуленые значени€ в калькул€торе при загрузке страницы
